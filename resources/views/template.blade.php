...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <!-- Search -->
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url('{{asset('images/cover1.jpg')}}');" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1 style="margin-top:35px">Search Your Item</h1>
              </div>
            </div>
            <div class="form-search-wrap" data-aos="fade-up" data-aos-delay="200">
              <form action="itemcategory" method="post">
								@csrf
                @method('POST')
                <div class="row align-items-center">
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-4">
                    <div class="select-wrap">
                      ...
                      <select class="form-control rounded" style="overflow-y: scroll; max-height: 200px" name="category" id="catid">
                  ...
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <input type="number" id="minprice" required="required" name="minprice" class="form-control rounded" placeholder="Min Price (Ks)" >
                  </div>
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <div class="wrap-icon">
                      <input type="number" name=" maxprice" required="required" id="maxprice" class="form-control rounded" placeholder="Max Price (Ks)" >
                    </div>
                    
                  </div>
                  <div class="col-lg-12 col-xl-2 ml-auto text-right">
                    <button id="findbtn" type="submit" class="btn text-white font-weight-bold btn-primary btn-block rounded">
