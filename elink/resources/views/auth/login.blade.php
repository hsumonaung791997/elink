          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block font-weight-bold">
                ...
                @guest
                  <li class="ml-xl-3 active"><a href="{{route('login')}}"><span class="border-left pl-xl-4"></span>Login</a></li>
                  @if (Route::has('register'))
                  <li class="ml-xl-3"><a href="{{route('register')}}"><span class="border-left pl-xl-4"></span>Register</a></li>
                  @endif
                @else
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 mb-3 mt-3"  data-aos="fade">
            ...
            <form action="{{route('login')}}" method="post" style="border:1px solid black;border-radius: 20px;" class="p-5 bg-white">
             @csrf
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <input type="password" placeholder="Enter Password " id="subject" name="password" class="form-control @error('password') is-invalid @enderror" style="border-radius: 7px;">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
              ...
              <div class="row form-group">
                <div class="col-12 text-center">
                  <p class="font-weight-bold">No account yet? <a href="{{route('register')}}">Register</a></p>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 text-center">
                  <input type="submit" value="Sign In" class="btn btn-primary py-2 px-4 text-white" style="border-radius: 7px;">
                </div>
              </div>
